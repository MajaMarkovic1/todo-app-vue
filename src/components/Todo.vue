    ...
    <div class="container">
        ...
        <div class="post-todo">
          <div class="col-5 form-group">
            ...
            <input
              type="text"
              class="form-control"
              v-model="newTodo.todo_item"
              required
            />
          </div>
          <div class="col-2 check">
            <input type="checkbox" v-model="newTodo.is_priority" /> Priority
          </div>
        </div>
      ...
      <div class="todo-wrapper">
        <div class="todo-list">
          ...
          <h5 class="todos" v-if="notPriority.length > 0">
            <strong>Todos</strong>:
          </h5>
          <ul
            class="shadow p-2 rounded my-todos"
            v-for="todo in notPriority"
            :key="todo.id"
          >
            <li>
              <label>{{ todo.todo_item }}</label>
        ...
        <div class="todo-done" v-if="doneTodos.length > 0">
          ...
          <ul
            class="shadow p-2 rounded bg-info"
  ...
  computed: {
    ...
    notPriority() {
      return this.todos.filter(
        todo => !todo["is_priority"] && !todo["is_done"]
      );
    },
